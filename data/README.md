...
| Millstone | `https://millstoneboro.org/calendar.php` | `importable` | `savvycitizen-plugin`; fetch the official homepage agenda plugin and keep community/family rows while skipping secondhand sale rows, bulk pickup, and meetings. |
